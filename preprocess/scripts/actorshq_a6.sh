...
--cloth_obj ${DATADIR}/a${ACTOR}_s${SEQUENCE}/vest_sim.obj \
--fix_v None \
--iteration 20 \
--filename ${DATADIR}/a${ACTOR}_s${SEQUENCE}/split_idx_upper.npz

python split_garments.py \
--mesh_path ${DATADIR}/a${ACTOR}_s${SEQUENCE}/FrameRec000${START_IDX}.obj \
--cloth_obj ${DATADIR}/a${ACTOR}_s${SEQUENCE}/pants_sim.obj \
--fix_v None \
--iteration 20 \
--filename ${DATADIR}/a${ACTOR}_s${SEQUENCE}/split_idx_lower.npz